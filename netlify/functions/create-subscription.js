...
exports.handler = async (event, context) => {
    ...
    // 1. Retrieve environment variables and initialize Supabase Admin Client
    const {
        SUPABASE_URL,
    ...
    // 2. NEW: Validate Supabase JWT from the Authorization header
    try {
    ...
    try {
        ...
        // 5. Update the user's Supabase account status (Downgrade to free)
